...
{/*
        ...
        <Image alt="star" src="img.svg" width={116} className=" top-0 absolute left-0" height={124}/> 

        <Image alt="star" src="img.svg" width={116} className=" top-0 absolute right-0" height={124}/> 

        <Image alt="star" src="img.svg" width={116} className="-mt-2 left-0 absolute bottom-4" height={124}/> 

        <Image alt="star" src="img.svg" width={116} className="-mt-2 right-0 sx:hidden md:absolute bottom-4" height={124}/> 
...
<div className="flex gap-10   border border-t-gray-100 shadow-lg  sx:flex-col md:flex-row justify-between mx-auto px-24 py-32">
    ...
    <aside className="w-full text-[#2E323A99] flex flex-col  ">
        <Image alt="star" src="/logo.jpg" width={352} height={8} className="-mt-24"/>
    </aside>
    ...
    <div className="flex sx:flex-col md:flex-row w-full md:gap-36 sx:gap-10">
        ...
        <aside className="flex flex-col gap-3 ">
            ...
            <Link href="/" className=" text-[#2E323A99]  flex flex-row gap-3  text-[14px]">Home</Link> 
            <Link href="/product" className=" text-[#2E323A99]  flex flex-row gap-3  text-[14px]">Produtos</Link>
        </aside>
